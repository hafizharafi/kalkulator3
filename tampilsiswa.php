    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <a href="editsiswa.php?idsiswa=<?php echo $datasiswa['idsiswa'];?>" class="btn btn-danger">EDIT</a>
                    <a href="hapussiswa.php?idsiswa=<?php echo $datasiswa['idsiswa'];?>" 
                       onclick="return confirm('Yakin Hapus?')" class="btn btn-success">HAPUS</a>
                </td>
            </tr>
            <?php } ?>
